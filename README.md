...
application source repository is private, while verified Windows builds remain
public here so existing installations can always update.
...
- [Download the latest Windows installer](https://github.com/CodingIsCoolFr/anisol-updates/releases/latest/download/Anime-Solution-Setup-0.11.47-win64.exe)
